...
- Complexité de la structure : Trouver le bon équilibre d'architecture sans sur-complexifier le projet dès le départ.
- Configuration des tests : Simuler les données (mocking) et configurer l'environnement de test pour le backend et le frontend.
